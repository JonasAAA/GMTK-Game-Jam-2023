...
* Download [Wwise Godot integration tool](https://github.com/alessandrofama/wwise-godot-integration/releases/download/1.6.0_Wwise2021.1.4.7707/Wwise.Godot.Integration.App.exe).
  ...
  * Choose integration version `1.6.0_Wwise2021.1.4.7707`, select all platforms, select Godot's project file (named `project.godot`), then click `Install`.
...
* Open Wwise, open the Wwise project which is in `wwise\Project`.
